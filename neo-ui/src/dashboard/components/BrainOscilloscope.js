...
const OscilloscopeCanvas = ({ cpu, ram, isPanic }) => {
    ...
    const draw = useCallback(() => {
        ...
        ctx.lineWidth = isPanic ? 2.5 : 2;
        ctx.shadowColor = color;
        ctx.shadowBlur = isPanic ? 16 : 8;
        ctx.stroke();
        ctx.shadowBlur = 0;
